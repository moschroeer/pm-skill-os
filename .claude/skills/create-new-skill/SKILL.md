...
description: Create a new reusable project skill from a recurring workflow. Use when the user asks to create a new skill, document a process as a skill, formalize a recurring task, or turn a workflow into a project skill.
---
...
**ID:** SKILL-META-002
**Owner:** [Your Name]
**Governance:** 🟡 Yellow — produces new governance-bearing artifacts; per `CLAUDE.md`, structural skill changes require owner approval and re-evaluation before activation
**Version:** 2.0
...
- The output is saved to `.claude/skills/{kebab-case-name}/SKILL.md` with a unique `SKILL-{DEPT}-{NNN}` ID.
